...
public:
	...
	virtual void GetFriendsGroupMembersList( FriendsGroupID_t friendsGroupID, CSteamID *pOutSteamIDMembers, int nMembersCount ) = 0;
	...
	virtual void ActivateGameOverlayToWebPage( const char *pchURL, int eMode = 0 ) = 0;

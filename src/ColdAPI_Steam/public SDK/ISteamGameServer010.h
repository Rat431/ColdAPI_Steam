...
public:
	...
	virtual uint32_t UserHasLicenseForApp( CSteamID steamID, AppId_t appID ) = 0;
	...
	virtual uint32_t BeginAuthSession( const void *pAuthTicket, int cbAuthTicket, CSteamID steamID ) = 0;

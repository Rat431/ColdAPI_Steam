...
public:										
	...
	virtual bool GetResultItemProperty( SteamInventoryResult_t resultHandle, 
										...
										char *pchValueBuffer, uint32 *punValueBufferSizeOut ) = 0;
...
//	STEAM_METHOD_DESC(Captures the entire state of the current users Steam inventory.)
	...
	virtual bool GenerateItems( SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs, ARRAY_COUNT(unArrayLength) const uint32 *punArrayQuantity, uint32 unArrayLength ) = 0;

...
public:
	...
	virtual SteamHandle_t OpenFileEx(const char* cszFileName, const char* cszMode, int nFlags, unsigned int* puFileSize, int* pnLocal, TSteamError* pError) = 0;
	...
	// ISteam005
	virtual int GetLocalClientVersion(unsigned int* puBootStrapperVersionNum, unsigned int* puClientAppVersionNum, TSteamError* pError) = 0;
	virtual int IsFileNeededByCache(unsigned int uCacheId, const char* cszFileName, unsigned int uFileSize, TSteamError* pError) = 0;
	...
	virtual int IsFileNeededByApp(unsigned int uAppId, const char* cszFileName, unsigned int uFileSize, unsigned int* puCacheId, TSteamError* pError) = 0;
	...
	virtual int GetAppDLCStatus( unsigned int uAppId, unsigned int uDLCCacheId, int* pbDownloaded, TSteamError* pError ) = 0;

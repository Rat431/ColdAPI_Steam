#pragma once
#include "../public SDK/ISteamRemoteStorage008.h"
#include "../Bridge.h"
#include "../ColdManager.h"

class SteamRemoteStorageIn008 : public ISteamRemoteStorage008
{
public:
	...
	{
		PublicSafe.lock();
		bool Call = ColdAPI_Storage::bCFileWriteStreamWriteChunk(hStream, pvData, cubData);
		PublicSafe.unlock();
		return Call;
	}
	...
	{
		PublicSafe.lock();
		bool Call = ColdAPI_Storage::bCFileWriteStreamClose(hStream);
		PublicSafe.unlock();
		return Call;
	}
	...
	{
		PublicSafe.lock();
		bool Call = ColdAPI_Storage::bCFileWriteStreamCancel(hStream);
		PublicSafe.unlock();
		return Call;
	}

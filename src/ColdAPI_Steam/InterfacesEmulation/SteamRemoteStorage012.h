#pragma once
#include "../public SDK/ISteamRemoteStorage012.h"
#include "../Bridge.h"
#include "../ColdManager.h"

class SteamRemoteStorageIn012 : public ISteamRemoteStorage012
{
public:
	...
	SteamAPICall_t UGCDownloadToLocation(UGCHandle_t hContent, const char* cszLocation, uint32 unPriority)
	{
		return NULL;
	}
};

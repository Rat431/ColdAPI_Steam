#pragma once
#include "../Bridge.h"
#include "../public SDK/ISteamUtils007.h"

class SteamUtilsIn007 : public ISteamUtils007
{
public:
	...
	bool ShowGamepadTextInput(EGamepadTextInputMode eInputMode, EGamepadTextInputLineMode eInputLineMode, const char* pchDescription, uint32 unCharMax, const char* pchExistingText)
	{
		return false;
	}
	...
	void SetOverlayNotificationInset(int32, int32)
	{
		return;
	}
};